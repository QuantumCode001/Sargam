                ...
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-6 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-zinc-800 scrollbar-track-transparent">
                    {[
                      ...
                      { name: 'Sonu Nigam', query: 'Sonu Nigam', img: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=300&q=80' }
                    ].map((artist, idx) => (
                      <button
                        key={idx}
                        onClick={() => {
                      ...
                      >
                        <div className={`w-20 h-20 sm:w-24 sm:h-24 rounded-full p-[3px] border-2 transition-all duration-300 ${
                          settings.darkMode 
                            ? 'border-white/10 group-hover:border-rose-500 shadow-[0_10px_20px_rgba(0,0,0,0.4)]' 
                            : 'border-black/5 group-hover:border-rose-500 shadow-[0_6px_15px_rgba(0,0,0,0.06)]'
                        }`}>
                          <img
                            src={artist.img}
                            alt={artist.name}
                        ...
                        <span className={`text-[11px] font-bold text-center mt-2.5 transition-colors group-hover:text-rose-500 ${
                          settings.darkMode ? 'text-zinc-300' : 'text-zinc-700'
                        }`}>
                          {artist.name}
                        </span>
                      </button>
...
�          {/* Global Header with Search Bar */}
          <div className={`mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b ${settings.darkMode ? 'border-white/5' : 'border-black/5'} pb-6`}>
            ...
            {/* Global Search Input Box */}
            <div className="relative w-full max-w-md md:ml-auto">�          {/* Global Header with Search Bar */}
          <div className={`mb-8 flex flex-col items-center md:flex-row md:items-center justify-between gap-4 border-b ${settings.darkMode ? 'border-white/5' : 'border-black/5'} pb-6`}>
            <div className="flex items-center space-x-3 lg:hidden">
              {/* Logo for mobile view */}
              <div className="w-8 h-8 rounded-lg overflow-hidden shadow-lg border border-white/5 flex-shrink-0">
                <img src="/sargam-logo.png" alt="Sargam Logo" className="w-full h-full object-cover select-none pointer-events-none" />
            ...
            {/* Global Search Input Box */}
            <div className="relative w-full max-w-md mx-auto md:mr-0 md:ml-auto">0�8�(�FCenter the search bar and header contents horizontally on mobile view.